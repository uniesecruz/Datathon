# -*- coding: utf-8 -*-
#
# Datathon_Recrutamento documentation build configuration file, created by
# sphinx-quickstart.
#
...
project = u'Datathon_Recrutamento'
...
latex_documents = [
    ('index',
     'llm.tex',
     u'Datathon_Recrutamento Documentation',
     u"Sergio_Alves_da_Cruz", 'manual'),
]
...
man_pages = [
    ('index', 'llm', u'Datathon_Recrutamento Documentation',
     [u"Sergio_Alves_da_Cruz"], 1)
]
